        ...
        <>
            ...
            >
                <p>
                    ...
                    &apos;in-line&apos; when you autosquare your CNC manually or
                    during homing then it will skew the x-axis and produce
                    off-square cuts (see the picture). You can fix this by
                    shimming the y-axis plates, realigning the y-axes, or tuning
                    the dual endstops if your CNC has autosquaring.
                </p>
                ...
                <ul>
                    <li>
                        Something pointed in the router like an old tapered bit,
                        v-bit, or a dowel
                    </li>
                    <li>3 squares of tape marked with an &apos;X&apos;</li>
                    <li>A long ruler or measuring tape</li>
                    <li>
                        The CNC positioned somewhere in the front, left corner
                        with the pointed tip close to the wasteboard
                    </li>
                </ul>
            </div>
            <div>
