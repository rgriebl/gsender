        ...
        <div style={{ fontSize: '1rem' }}>
            ...
            <div className={styles.joystickOption}>
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick1.horizontal.primaryAction
                            ? String(
                                  stick1.horizontal.primaryAction,
                              ).toUpperCase()
                            : 'None',
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick1.horizontal.secondaryAction
                            ? String(
                                  stick1.horizontal.secondaryAction,
                              ).toUpperCase()
                            : 'None',
            ...
            <div className={styles.joystickOption}>
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick1.vertical.primaryAction
                            ? String(
                                  stick1.vertical.primaryAction,
                              ).toUpperCase()
                            : 'None',
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick1.vertical.secondaryAction
                            ? String(
                                  stick1.vertical.secondaryAction,
                              ).toUpperCase()
                            : 'None',
            ...
            <div className={styles.joystickOption}>
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick1.mpgMode.primaryAction
                            ? String(stick1.mpgMode.primaryAction).toUpperCase()
                            : 'None',
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick1.mpgMode.secondaryAction
                            ? String(
                                  stick1.mpgMode.secondaryAction,
                              ).toUpperCase()
                            : 'None',
            ...
            <div className={styles.joystickOption}>
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick2.horizontal.primaryAction
                            ? String(
                                  stick2.horizontal.primaryAction,
                              ).toUpperCase()
                            : 'None',
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick2.horizontal.secondaryAction
                            ? String(
                                  stick2.horizontal.secondaryAction,
                              ).toUpperCase()
                            : 'None',
            ...
            <div className={styles.joystickOption}>
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick2.vertical.primaryAction
                            ? String(
                                  stick2.vertical.primaryAction,
                              ).toUpperCase()
                            : 'None',
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick2.vertical.secondaryAction
                            ? String(
                                  stick2.vertical.secondaryAction,
                              ).toUpperCase()
                            : 'None',
            ...
            <div className={styles.joystickOption}>
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick2.mpgMode.primaryAction
                            ? String(stick2.mpgMode.primaryAction).toUpperCase()
                            : 'None',
                ...
                <Select
                    ...
                    placeholder={null}
                    value={{
                        label: stick2.mpgMode.secondaryAction
                            ? String(
                                  stick2.mpgMode.secondaryAction,
                              ).toUpperCase()
                            : 'None',
