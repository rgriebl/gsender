    ...
    return (
        ...
        >
            ...
            <Modal.Body style={modalBodyStyle}>
                {list?.size === 1 ? (
                    <p>
                        There is <span style={{ fontWeight: 'bold' }}>1</span>{' '}
                        invalid G-Code line in the file, your job may not run
                        properly.
                    </p>
                ) : (
                    <p>
                        There are{' '}
                        <span style={{ fontWeight: 'bold' }}>{list?.size}</span>{' '}
                        invalid G-Code lines in the file, your job may not run
                        properly.
                    </p>
                )}
            </Modal.Body>
