    ...
    command(cmd, ...args) {
        const handler = {
            ...
            'gcode:load': () => {
                ...
                const gcodeWithoutComments = gcode.replace(
                    bracketCommentLine,
                    '',
                );

                const containsACommand =
                    A_AXIS_COMMANDS.test(gcodeWithoutComments);
                const containsYCommand =
                    Y_AXIS_COMMANDS.test(gcodeWithoutComments);
