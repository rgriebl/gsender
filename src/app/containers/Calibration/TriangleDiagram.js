...
const Triangle = ({ children }) => (
    <div className={styles.triangle}>{children}</div>
);
            ...
            >
                {hasTop && (
                    <div
                        className={classnames(
                            styles.arrowHead,
                            isActive ? styles.arrowHeadActive : '',
                        )}
                    />
                )}
                ...
                {hasBottom && (
                    <div
                        className={classnames(
                            styles.arrowTail,
                            isActive ? styles.arrowTailActive : '',
                        )}
                    />
                )}
            </div>
...
TriangleDiagram.propTypes = {
    circlePoints: PropTypes.array,
