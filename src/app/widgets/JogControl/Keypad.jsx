...
class Keypad extends PureComponent {
    ...
    renderRationalNumberWithBoundedDenominator(value) {
        ...
        const maximumDenominator =
            Math.pow(10, Number(denominatorDigits) || 0) - 1; // 10^4 - 1 = 9999
        const [quot, numerator, denominator] = frac(
            value,
            maximumDenominator,
            true,
        );
    ...
    renderMenuItems() {
        ...
        const unitSteps =
            this.state.units === METRIC_UNITS ? METRIC_STEPS : IMPERIAL_STEPS;
                ...
                <div className={styles.keysBody}>
                    <div className={styles.xyKeys}>
                        <JogControl
                            ...
                            continuousJog={() =>
                                actions.startContinuousJog(
                                    { X: -1, Y: 1 },
                                    feedrate,
                                )
                            }
                            stopContinuousJog={() =>
                                actions.stopContinuousJog()
                            }
                        ...
                        <JogControl
                            ...
                            jog={() =>
                                actions.jog({ Y: xyDistance, F: feedrate })
                            }
                            continuousJog={() =>
                                actions.startContinuousJog({ Y: 1 }, feedrate)
                            }
                            stopContinuousJog={() =>
                                actions.stopContinuousJog()
                            }
                        ...
                        <JogControl
                            ...
                            jog={() =>
                                actions.jog({ Z: zDistance, F: feedrate })
                            }
                            continuousJog={() =>
                                actions.startContinuousJog({ Z: 1 }, feedrate)
                            }
                            stopContinuousJog={() =>
                                actions.stopContinuousJog()
                            }
                        ...
                        <JogControl
                            ...
                            jog={() =>
                                actions.jog({ X: -xyDistance, F: feedrate })
                            }
                            continuousJog={() =>
                                actions.startContinuousJog({ X: -1 }, feedrate)
                            }
                            stopContinuousJog={() =>
                                actions.stopContinuousJog()
                            }
                    ...
                    <div className={styles.presetControls}>
                        <FunctionButton
                            className={cx({
                                [styles.activeButton]: rapidActive,
                            })}
                            disabled={!canClick}
                            type="button"
                            onClick={() => {
                        ...
                        <FunctionButton
                            className={cx({
                                [styles.activeButton]: normalActive,
                            })}
                            disabled={!canClick}
                            onClick={() => {
                        ...
                        <FunctionButton
                            className={cx({
                                [styles.activeButton]: preciseActive,
                            })}
                            disabled={!canClick}
                            onClick={() => {
