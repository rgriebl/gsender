...
const DataCollectionPopup = (_, ref) => {
    ...
    const handleAccept = async () => {
        ...
        await api.metrics.toggleCollectDataStatus({
            collectUserDataStatus: USER_DATA_COLLECTION.ACCEPTED,
        });
    };
    ...
    const handleReject = async () => {
        ...
        await api.metrics.toggleCollectDataStatus({
            collectUserDataStatus: USER_DATA_COLLECTION.REJECTED,
        });
    };
        ...
        <div className={styles.consentPopup}>
            ...
            <div className={styles.consentArea}>
                ...
                <div>
                    ...
                    <p>
                        To continue making gSender better we&apos;re trying to
                        get a count on how many people use it, what CNC they use
                        it for, what computer they run it on, and other app
                        usage statistics.
                    </p>

                    <p>
                        This is completely optional and anonymous and we&apos;ll
                        only do it with your permission. You can opt in or out
                        at any time.
                    </p>
