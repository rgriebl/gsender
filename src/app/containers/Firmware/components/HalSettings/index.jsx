...
import {
    ...
    FirmwareContext,
    getDatatypeInput,
} from 'Containers/Firmware/utils';
...
const HalSettings = ({ descriptions }) => {
    const { settings, setSettings, setSettingsToApply } =
    ...
    return (
        <div className={styles.settingsContainer}>
            ...
            {settings.map((setting, index) => {
                ...
                const { message, dataType, ...info } = descriptionLookup(
                    settingKey,
                    descriptions,
                );
                ...
                const categoryClass =
                    (Number(setting.groupID ? setting.groupID : 0) % 9) + 1;
