...
//
const getShouldInstallUpdates = () =>
    new Promise((resolve, reject) => {
        authrequest.get('/api/version/appUpdateSupport').end((err, res) => {
            if (err) {
                reject(res);
            } else {
                resolve(res);
...
events.clearAll = () =>
    new Promise((resolve, reject) => {
        authrequest.delete('/api/events').end((err, res) => {
            if (err) {
                reject(res);
            } else {
                resolve(res);
...
log.printLog = (msg, file, lineNumber, level) =>
    new Promise((resolve, reject) => {
        authrequest
            .post('/api/log')
            .send({ msg: msg })
...
metrics.sendData = (machineProfile) =>
    new Promise((resolve, reject) => {
        authrequest
...
metrics.getCollectDataStatus = (options) =>
    new Promise((resolve, reject) => {
        authrequest
...
metrics.toggleCollectDataStatus = (options) =>
    new Promise((resolve, reject) => {
        authrequest
