describe('Jog with GRBL', () => {
    it('Connects and Jogs with Keyboard', () => {
        ...
        cy.get('.widgets-NavbarConnection-Index__NavbarConnection--3X935')
            .click()
            .realHover('mouse');
        ...
        cy.contains('Jog: X+ Y-')
            ...
            .children()
            .children(
                '.containers-Preferences-Shortcuts-edit-area__icon-area--E8hwc',
            )
            .click();
        ...
        cy.wait(1000);
        cy.get(
            '.widgets-Location-components-MachinePositionInput__position-input--15_Nd',
        )
            .first()
